        ...
        >
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div>
                <h3 className="text-xl font-medium mb-3">Design Skills</h3>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-2/3 h-2/3 border-2 border-zinc-800 rounded-md -z-10"></div>
          </div>
        </motion.div>
      </div>
    </section>
