...
const Work: React.FC = () => {
  ...
  return (
    <section id="work" className="py-24 md:py-32 bg-zinc-900">
            ...
            >
              <div className="bg-zinc-800 rounded-lg overflow-hidden">
                <div className="aspect-[4/3] bg-zinc-700 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-zinc-900 opacity-0 group-hover:opacity-70 transition-opacity flex items-center justify-center">
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="bg-zinc-700 rounded-full w-8 h-8 flex items-center justify-center transform group-hover:rotate-45 transition-transform duration-300">
